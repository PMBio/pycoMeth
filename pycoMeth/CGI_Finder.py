                        ...
                        if valid_window(c_count, g_count, cg_count, min_win_len, min_CG_freq, min_obs_CG_ratio):
                            ...
                            if previous_valid:
                                ...
                                if i == len(seq) - min_win_len - 1:
                                    ...
                                    win_len, win_cg_count, win_cg_freq, win_obs_exp = compute_win(
                                        seq[valid_win_start:valid_win_end]
                                    )  # Sometimes valid merged windows are not excatly matching the definition of a proper CpG_island
                                    writer.write(
                                        seq_name,
                                        valid_win_start,
                                        valid_win_end,
